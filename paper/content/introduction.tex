...
\gallais{I have a hard time formulating this:
  and are convinced that additional engineering taking advantage of existing
  work (e.g. Quickhick) we can satisfy more of the optional criteria
}
