...
and
%
\IdrisData{App} which takes a function and an argument of type the function's domain
...
Using \IdrisType{Prim} structural operations can now be implemented by handling recursive calls on \IdrisData{Call} nodes' subterms uniformly before dispatching on the operator to see whether additional simplifications can be deployed.
