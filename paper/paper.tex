...
In fact we will describe in \Cref{sec:semantics} how we can use our \acp{edsl} to both verify our static semantics whilst describing our dynamic semantics.
